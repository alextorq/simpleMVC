...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../node_modules/bootstrap-scss/bootstrap.scss":[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"assets/styles/index.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
},{}],"assets/scripts/Model.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(Model, [{
    ...
    value: function addItem(item) {
      var itemModel = this.createItem(item);
    ...
    value: function loadItems(items) {
      ...
      (_this$todos = this.todos).push.apply(_this$todos, _toConsumableArray(items));
    ...
    key: "_findItemIndex",
    value: function _findItemIndex(id) {
      return this.todos.findIndex(function (item) {
        return item.id === id;
      });
    }
    /**
    ...
    value: function deleteItem(id) {
      ...
      this.dispatch.fireEvent('deleteModelItem', {
        id: id
      });
    }
    /** 
    ...
    value: function editItem(item) {
      var index = this._findItemIndex(item.id);
...
var _default = Model;
exports.default = _default;
},{"./PubSub.js":"assets/scripts/PubSub.js"}],"assets/scripts/Observer.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(Observer, [{
    ...
    value: function fireEvent(value) {
      for (var iterator in this.subscriber) {
...
function () {
  ...
  _createClass(View, [{
    ...
    key: "createItem",
    value: function createItem(node) {
      var wrapper = document.createElement('li');
      var classPrefix = node.complete ? ' complete' : '';
      wrapper.classList = 'todo__item left-transform' + classPrefix;
      wrapper.id = "todo__id_".concat(node.id);
    ...
    value: function addHandlers() {
      ...
      this.rootEl.addEventListener('submit', function (event) {
        event.preventDefault();

        if (!_this._temporaryText) {
          return;
        }

        ;

        _this.dispatch.fireEvent('addViewItem', {
          text: _this._temporaryText
        });

        _this.clearForm();
      });
      this.inputTODO.addEventListener('change', function (event) {
        _this._temporaryText = event.target.value;
      });
      this.todoList.addEventListener('change', function (event) {
        var target = event.target;
        var parent = target.closest('.todo__item');
        var id = +parent.id.replace('todo__id_', '');
        var text = parent.querySelector('.form-control').value;
        var complete = parent.querySelector('label input').checked;
        var classPrefix = complete ? ' complete' : '';
        parent.classList = 'todo__item' + classPrefix;

        _this.dispatch.fireEvent('editViewItem', {
          id: id,
          text: text,
          complete: complete
        });
      ...
      this.todoList.addEventListener('click', function (event) {
        ...
        _this.dispatch.fireEvent('deleteViewItem', {
          id: id
        });
      });
    ...
    key: "deleteItem",
    value: function deleteItem(id) {
      var parent = document.getElementById('todo__id_' + id);
...
var _default = View;
exports.default = _default;
},{"./PubSub.js":"assets/scripts/PubSub.js","./Observer":"assets/scripts/Observer.js"}],"../node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
exports.default = void 0;
var api = {
  prefix: 'http://192.168.81.253:4000',
  todo: {
    add: '/todo/add',
    delete: '/todo/delete',
    all: '/todo/list',
...
var _default = api;
exports.default = _default;
},{}],"assets/scripts/Controller.js":[function(require,module,exports) {
"use strict";
...
function () {
  function Controller(model, view) {
    ...
    this.view = view;
    this.loadItems();
    this.view.dispatch.addListener('editViewItem', function (event) {
      _this.model.editItem(event);
    });
    this.view.dispatch.addListener('addViewItem', function (event) {
      _this.model.addItem(event.text);
    });
    this.view.dispatch.addListener('deleteViewItem', function (event) {
      _this.model.deleteItem(event.id);
    });
    this.model.dispatch.addListener('editModelItem', function (modelItem) {
      _this.editItem(modelItem);
    });
    this.model.dispatch.addListener('deleteModelItem', function (modelItem) {
      _this.view.deleteItem(modelItem.id);

      _this.deleteItem(modelItem);
    });
    this.model.dispatch.addListener('loadModelItems', function (modelItem) {
      _this.view.loadItems(modelItem);

      _this.view.togglePreloader();
    });
    this.model.dispatch.addListener('addModelItem', function (modelItem) {
      _this.view.createItem(modelItem);

      _this.saveItem(modelItem);
    });
  }
  /**
  ...
  _createClass(Controller, [{
    ...
    value: function loadItems() {
      ...
      _axios.default.get(_api.default.prefix + _api.default.todo.all).then(function (response) {
        _this2.model.loadItems(response.data);
      }).catch(function (err) {
    ...
    key: "editItem",
    value: function editItem(modelItem) {
      _axios.default.patch(_api.default.prefix + _api.default.todo.edit, modelItem).then(function (response) {}).catch(function (err) {
        return console.error(err);
      });
    }
    /**
    ...
    value: function saveItem(modelItem) {
      _axios.default.post(_api.default.prefix + _api.default.todo.add, modelItem).then(function (response) {
    ...
    key: "deleteItem",
    value: function deleteItem(modelItem) {
      _axios.default.delete(_api.default.prefix + _api.default.todo.delete, modelItem).then(function (response) {
        console.log(response);
      }).catch(function (err) {
        return console.error(err);
      });
...
exports.default = _default;
},{"axios":"../node_modules/axios/index.js","./api":"assets/scripts/api.js"}],"assets/scripts/app.js":[function(require,module,exports) {
"use strict";
...
var app = new _Controller.default(new _Model.default(), new _View.default(root));
},{"./Model":"assets/scripts/Model.js","./View":"assets/scripts/View.js","./Controller":"assets/scripts/Controller.js"}],"assets/scripts/index.js":[function(require,module,exports) {
"use strict";
...
require("./app");
},{"babel-polyfill":"../node_modules/babel-polyfill/lib/index.js","bootstrap-scss":"../node_modules/bootstrap-scss/bootstrap.scss","../styles/index.scss":"assets/styles/index.scss","./app":"assets/scripts/app.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
